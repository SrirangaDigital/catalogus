...
define('FB_SUBJECT_PREFIX', '[UOM Website Feedback] ');
...
define('REG_VERIFY_SUB', '[UOM] Please verify your email');
...
define('REG_CONFIRM_SUB', '[UOM] Registration confirmed');
...
define('PWD_RESET_SUB', '[UOM] Password reset request received');
...
define('PWD_RESET_LINK_SUB', '[UOM] Password successfully reset');
